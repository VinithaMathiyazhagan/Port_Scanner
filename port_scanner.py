...
#Argument parsing
help_message = ("USAGE:\n" +
                "This script scans the provided port against the given target host\n" +
				"Example:\n" +
				"port_scanner.py -t 192.168.182.111 -p 21 22 8200 -s 20") 
parser = argparse.ArgumentParser(usage=help_message, description='Scan TCP ports')
parser.add_argument('-t', help='IP of the target host, separated by blank spaces', default=False, nargs='*')
